    ...
    return (
        ...
        <div className="min-h-screen flex flex-col items-center bg-gradient-to-b from-[#CBB59F] to-[#DED6CB] py-16">
            ...
            <div className="bg-LightBGColor shadow-2xl rounded-lg p-10 max-w-4xl w-full text-center text-[#7A6752] mt-12"
                ...
                {/* Contact Form */}
                <form className="mt-10 space-y-6 max-w-lg mx-auto" data-aos="fade-up" data-aos-delay="500">
                    <div className="flex flex-col">
                        <label htmlFor="name" className="text-lg mb-2">Your Name</label>
                        <input id="name" type="text" className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#7A6752] transition-all duration-300 transform hover:scale-105 focus:scale-110" />
                    </div>
                    <div className="flex flex-col">
                        <label htmlFor="email" className="text-lg mb-2">Your Email</label>
                        <input id="email" type="email" className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#7A6752] transition-all duration-300 transform hover:scale-105 focus:scale-110" />
                    </div>
                    <div className="flex flex-col">
