...
export default function Service() {
  ...
  return (
    <div className='bg-MainBGColorYellow min-h-screen overflow-x-hidden'>
      <h1 className='text-center text-3xl font-bold text-gray-900' data-aos="fade-down">
        Luxury Home Salon
      </h1>

      <div className='flex justify-center items-center p-5'>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-6 bg-LightBGColor p-4 sm:p-8 rounded-xl w-full max-w-screen-lg mx-auto">
          {/* Service 1: Nail Art */}
