...
const CardNailArt = () => {
  ...
  return (
    <CartProvider>
      <div className="flex justify-between w-full h-full bg-gray-100">

        {/* Left Sticky Container */}
        <LeftCard />

        {/* Middle Container (Products Container - 60% Width) */}
        <div className="sm:w-[60%] w-full mx-2 sm:mx-auto my-8 bg-MainBGColorYellow mt-4 rounded-xl h-full">
          <div className={`w-fit max-w-xl h-fit m-3 mx-auto`}>
            <div className="w-full mx-auto sticky top-0.5 sm:top-8 flex flex-col justify-center items-center h-fit">
              ...
              <div className="space-x-4 text-center">
                <button
                  className={`px-4 py-2 ${IsSelect ? "bg-BGColorYellow" : "bg-gray-400"} ${IsSelect ? "border-2" : "border-none"} border-black text-white rounded z-50`}
                  onClick={() => {
