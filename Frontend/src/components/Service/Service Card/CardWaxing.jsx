    ...
    <div className={`w-fit max-w-xl h-fit m-3 mx-auto ${isActive ? "my-0" : "my-60"}`}>
      ...
      <div className='space-x-4 '>
        <button
          ...
          onClick={() => {setType('WaxingNormal'); toggleActive();
            toggleSelect1();
          }}
        >
          Normal Wax
        ...
        <button
          ...
          onClick={() => {setType('WaxingRica'); toggleActive();
            toggleSelect2();
          }} >
          Rica Wax
        </button>
      ...
      <div className="px-5 pb-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className='text-red-500 m-2 text-lg font-bold line-through'>₹{product.offerprice}</span><span> </span>
